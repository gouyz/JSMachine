...
private let kSearchShopCell = "kSearchShopCell"

class JSMSearchShopVC: GYZBaseVC {
    ...
    lazy var collectionView: UICollectionView = {
        ...
        collView.register(JSMTuiJianGoodsCell.self, forCellWithReuseIdentifier: kSearchShopCell)
    ...
    func requestGoodsDatas(){
        ...
        GYZNetWork.requestNetwork("shop/searchGoods",parameters: ["pro_name":searchContent],  success: { (response) in
...
extension JSMSearchShopVC: UICollectionViewDataSource,UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: kSearchShopCell, for: indexPath) as! JSMTuiJianGoodsCell
