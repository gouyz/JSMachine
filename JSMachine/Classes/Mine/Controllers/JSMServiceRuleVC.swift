//
//  JSMServiceRuleVC.swift
//  JSMachine
//  服务协议
//  Created by gouyz on 2018/12/25.
...
class JSMServiceRuleVC: GYZBaseVC {
    ...
    func requestGetURL(){
        ...
        GYZNetWork.requestNetwork("my/agreement",  success: { (response) in
...
extension JSMServiceRuleVC : WKNavigationDelegate{
